 ...
 *
 */
export async function navigateToAdminHomePage(sysAdminPage: Page) {
...
/**
 * Helper function to delete apps created during tests.
 */
export async function deleteAppsForTest(
  sysAdminPage: Page,
  appsToDelete: string[]
) {
